...
void xor_buf(const BYTE in[], BYTE out[], int len)
{
	int idx;
...
void aes_encrypt_ctr(const BYTE in[], int in_len, BYTE out[], const WORD key[], int keysize, const BYTE iv[])
{
	int idx = 0, last_block_length;
...
void aes_decrypt_ctr(const BYTE in[], int in_len, BYTE out[], const WORD key[], int keysize, const BYTE iv[])
{
