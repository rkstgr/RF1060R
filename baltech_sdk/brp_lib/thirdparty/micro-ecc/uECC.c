...
typedef unsigned long long uint64_t;
    ...
    #elif defined(__i386__) || defined(_M_IX86) || defined(_X86_) || defined(__I86__) || defined(__amd64__) || defined(_M_X64)
...
static int EccPoint_compute_public_key(EccPoint *result, uECC_word_t *private) {
	...
	{
    uECC_word_t carry = vli_add(tmp1, private, curve_n);
...
int uECC_shared_secret(const uint8_t public_key[uECC_BYTES*2],
    ...
    // attack to learn the number of leading zeros.
	{
	uECC_word_t carry = vli_add(private, private, curve_n);
